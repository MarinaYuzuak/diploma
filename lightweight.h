...
/// <summary>
/// Определяет, пересекаются ли два паралеллепипеда.
/// </summary>
/// <param name="P1"></param>
/// Восемь координат точек первого паралеллепипеда в соответствии с локальной нумерацией.
/// <param name="P2"></param>
/// Восемь координат точек второго паралеллепипеда в соответствии с локальной нумерацией.
/// <returns></returns>
